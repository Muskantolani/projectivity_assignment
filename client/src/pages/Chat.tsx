...
export default function Chat() {
    ...
    return (
        <div className={`w-full  ${theme === 'on' ? 'bg-gray-50' : "bg-slate-950"} flex flex-col items-center justify-center`}>
            ...
            {loading && <Loading />}
            <div className={`lg:w-10/12 mx-2 w-full h-[980px] shadow  ${theme === 'on' ? 'bg-gray-200' : "bg-slate-700 "}  rounded-xl flex relative  `}>
